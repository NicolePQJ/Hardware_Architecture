...
arch_file_path = os.path.join(this_directory, "..", "..","table7_eyeriss_setup","arch", "arch.yaml")
components_file_path = os.path.join(this_directory, "..", "architecture", "components.yaml")
sparse_iact_opt_file_path = os.path.join(this_directory, "..", "..","table7_eyeriss_setup","sparse_opt", "sparse_iact_opt.yaml")
dense_iact_opt_file_path = os.path.join(this_directory, "..", "..","table7_eyeriss_setup","sparse_opt", "dense_iact_opt.yaml")
workload_dir_path = os.path.join(this_directory, "..", "..","table7_eyeriss_setup", "workload")
ert_path = os.path.join(this_directory, "..", "..","table7_eyeriss_setup","ert_art", "ERT.yaml")
art_path = os.path.join(this_directory, "..", "..","table7_eyeriss_setup","ert_art", "ART.yaml")
mappings_dir = os.path.join(this_directory, "..", "..","table7_eyeriss_setup","mappings_found")
